...
<body>
    <div class="container">
        ...
        <div class="alert alert-warning">
            <p><i class="fa fa-warning"></i> <strong>Attention :</strong> Vous êtes sur le point de supprimer le client numéro <?= htmlspecialchars($client['id']) ?>.</p>
        </div>

        <?php if ($hasReservations): ?>
            <div class="alert alert-danger">
                <p><i class="fa-solid fa-skull-crossbones"></i><strong>Ce client est associé à <?= $count ?> réservation(s).</strong></p>
